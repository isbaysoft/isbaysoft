...
private
  ...
  def require_admin
    redirect_to_and_notice root_url, "Доступ запрещен" unless current_user and current_user.allow('Administrator')
  end
  ...
  def require_no_user
    redirect_to_and_notice root_url, "You must be logged out to access this page" unless current_user.anonymous?
  end
